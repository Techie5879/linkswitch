...
- **Routing is still by source app, not URL.** Per-app rules use the opening app’s bundle ID. LinkSwitch does not match on hostname or path; see `source-app-resolution.md`.
